...
<div id="main_role_resource_alert" style="width: 300px;height: 500px;" class="easyui-window" data-options="closed:true,modal:true">
    ...
    <div style="display:flex;justify-content:center;margin-top: 10px;">
        <a class="easyui-linkbutton" href="javascript:role_resourcesave()" style="display: inline-block; width: 200px;height: 35px;">保 存</a>
    </div>
</div>
...
<div id="main_role_alert" class="easyui-window" data-options="closed:true,modal:true">
    ...
    <div style="display:flex;justify-content:center;margin-top: 10px;">
        <a class="easyui-linkbutton" href="javascript:rolesave()" style="display: inline-block; width: 200px;height: 35px;">保 存</a>
    </div>
